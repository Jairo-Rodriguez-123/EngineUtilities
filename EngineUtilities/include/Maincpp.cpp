...
int main() {
  ...
  std::cout << "Nuestra sqrt(" << test_val << "): " << EngineUtilities::Math::sqrt(test_val) << " (esperado 5.0000)" << std::endl;
  std::cout << "Nuestra sqrt(2.0f): " << EngineUtilities::Math::sqrt(2.0f) << " (esperado 1.4142)" << std::endl;

  std::cout << "Nuestra abs(-5.5f): " << EngineUtilities::Math::abs(-5.5f) << std::endl;
  std::cout << "Nuestra EMax(10.0f, 20.0f): " << EngineUtilities::Math::EMax(10.0f, 20.0f) << std::endl;
  std::cout << "Nuestra EMin(10.0f, 20.0f): " << EngineUtilities::Math::EMin(10.0f, 20.0f) << std::endl;

  std::cout << "Nuestra round(3.4f): " << EngineUtilities::Math::round(3.4f) << std::endl;
  std::cout << "Nuestra round(3.6f): " << EngineUtilities::Math::round(3.6f) << std::endl;
  std::cout << "Nuestra round(3.5f): " << EngineUtilities::Math::round(3.5f) << std::endl; 
  std::cout << "Nuestra round(-3.4f): " << EngineUtilities::Math::round(-3.4f) << std::endl;
  std::cout << "Nuestra round(-3.6f): " << EngineUtilities::Math::round(-3.6f) << std::endl;
  std::cout << "Nuestra round(-3.5f): " << EngineUtilities::Math::round(-3.5f) << std::endl;

  std::cout << "Nuestra floor(5.7f): " << EngineUtilities::Math::floor(5.7f) << std::endl;
  std::cout << "Nuestra floor(-5.7f): " << EngineUtilities::Math::floor(-5.7f) << std::endl;
  std::cout << "Nuestra ceil(5.2f): " << EngineUtilities::Math::ceil(5.2f) << std::endl;
  std::cout << "Nuestra ceil(-5.2f): " << EngineUtilities::Math::ceil(-5.2f) << std::endl;
  ...
  std::cout << "Nuestra sin(90 deg): " << EngineUtilities::Math::sin(angle_90_deg) << " (esperado 1.0000)" << std::endl;
  std::cout << "Nuestra cos(90 deg): " << EngineUtilities::Math::cos(angle_90_deg) << " (esperado 0.0000)" << std::endl;
  std::cout << "Nuestra sin(0 deg): " << EngineUtilities::Math::sin(angle_0_deg) << " (esperado 0.0000)" << std::endl;
  std::cout << "Nuestra cos(0 deg): " << EngineUtilities::Math::cos(angle_0_deg) << " (esperado 1.0000)" << std::endl;
  std::cout << "Nuestra sin(30 deg): " << EngineUtilities::Math::sin(angle_30_deg) << " (esperado 0.5000)" << std::endl;
  std::cout << "Nuestra cos(30 deg): " << EngineUtilities::Math::cos(angle_30_deg) << " (esperado 0.8660)" << std::endl;
  std::cout << "Nuestra sin(180 deg): " << EngineUtilities::Math::sin(angle_180_deg) << " (esperado 0.0000)" << std::endl;
  std::cout << "Nuestra cos(180 deg): " << EngineUtilities::Math::cos(angle_180_deg) << " (esperado -1.0000)" << std::endl;

  std::cout << "\n--- Pruebas de Math Inverse Trig ---\n";
  std::cout << "Nuestra asin(0.5): " << EngineUtilities::Math::degrees(EngineUtilities::Math::asin(0.5f)) << " deg (esperado 30.0000)\n";
  std::cout << "Nuestra acos(0.5): " << EngineUtilities::Math::degrees(EngineUtilities::Math::acos(0.5f)) << " deg (esperado 60.0000)\n";
  std::cout << "Nuestra atan(1.0): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan(1.0f)) << " deg (esperado 45.0000)\n";
  std::cout << "Nuestra atan2(1, 1): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(1.0f, 1.0f)) << " deg (esperado 45.0000)\n";
  std::cout << "Nuestra atan2(1, -1): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(1.0f, -1.0f)) << " deg (esperado 135.0000)\n";
  std::cout << "Nuestra atan2(-1, -1): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(-1.0f, -1.0f)) << " deg (esperado -135.0000)\n";
  std::cout << "Nuestra atan2(-1, 1): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(-1.0f, 1.0f)) << " deg (esperado -45.0000)\n";
  std::cout << "Nuestra atan2(1, 0): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(1.0f, 0.0f)) << " deg (esperado 90.0000)\n";
  std::cout << "Nuestra atan2(-1, 0): " << EngineUtilities::Math::degrees(EngineUtilities::Math::atan2(-1.0f, 0.0f)) << " deg (esperado -90.0000)\n";
  ...
  std::cout << "Rotacion Y 90 deg: " << q_rot_y_90 << std::endl;
  ...
  std::cout << "\nRotacion Z 45 deg: " << q_rot_z_45 << std::endl;
  ...
  std::cout << "SLERP (0.5) de identidad a Rot Y 90: " << slerped_q << std::endl;
  ...
  std::cout << "\n--- Cuaternion <-> Matrix4x4 Conversions ---" << std::endl;
  ...
  std::cout << "Cuaternión de eje-ángulo (90 deg alrededor de (1,1,0) normalizado):\n" << q_from_axis_angle << std::endl;
